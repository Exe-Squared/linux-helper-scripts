...
wget -O - https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/.bash_aliases >"${HOME}/.bash_aliases"
wget -O - https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/.bash_profile >"${HOME}/.bash_profile"
wget -O - https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/.bashrc >"${HOME}/.bashrc"
...
wget -O - https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/setup-site >"${HOME}/.local/bin/setup-site"
chmod 755 "${HOME}/.local/bin/setup-site"

info "Configuring tmux"
sleep 2

wget -O - https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/tmux-sessionizer >"${HOME}/.local/bin/tmux-sessionizer"
...
# Install scripts
wget -O "$HOME/.local/bin/compare-env" https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/compare-env.py
wget -O "$HOME/.local/bin/get-image" https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/get-image
wget -O "$HOME/.local/bin/install-php" https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/install-php.sh
wget -O "$HOME/.local/bin/composer-via-docker" https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/composer-via-docker
wget -O "$HOME/.local/bin/php-via-docker" https://raw.githubusercontent.com/Exe-Squared/linux-helper-scripts/main/alma/files/php-via-docker
