...
# install docker
wget --quiet -O - https://raw.githubusercontent.com/benexesquared/linux-helper-scripts/main/ubuntu/docker-install.sh | bash
...
# install php
wget --quiet -O - https://raw.githubusercontent.com/benexesquared/linux-helper-scripts/main/ubuntu/php-install.sh | bash
